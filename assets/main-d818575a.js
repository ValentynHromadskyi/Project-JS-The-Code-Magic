import{a as g}from"./vendor-a61d8330.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const c of document.querySelectorAll('link[rel="modulepreload"]'))o(c);new MutationObserver(c=>{for(const s of c)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function r(c){const s={};return c.integrity&&(s.integrity=c.integrity),c.referrerpolicy&&(s.referrerPolicy=c.referrerpolicy),c.crossorigin==="use-credentials"?s.credentials="include":c.crossorigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(c){if(c.ep)return;c.ep=!0;const s=r(c);fetch(c.href,s)}})();const f="https://food-boutique.b.goit.study/api";async function B(){try{return await g.get(`${f}/products/categories`)}catch(t){console.log(t.message)}}async function y(t){try{return(await g.get(`${f}/products/${t}`)).data}catch(e){console.log(e.message)}}async function x(){try{return await g.get(`${f}/products/popular?limit=5`)}catch(t){console.log(t.message)}}async function M(){try{return await g.get(`${f}/products/discount`)}catch(t){console.log(t.message)}}document.querySelector(".foot-form");document.querySelector(".modal-subscription");document.querySelector(".modal-unsubscription");document.querySelector(".modal-backdrop");document.querySelector(".body");document.body.style.overflow;const i={filterCatList:document.querySelector(".filters-categories"),form:document.getElementById("fiters-form"),filtersInput:document.querySelector(".filters-input"),filtersCategories:document.querySelector(".filters-categories")};i.form&&i.form.addEventListener("input",k);i.form&&i.form.addEventListener("submit",k);T();async function T(){try{const e=(await B()).data;for(let r=0;r<e.length;r++)i.filterCatList.insertAdjacentHTML("beforeend",`<option class="filters-categories-option" value="${e[r]}">${e[r]}</option>`)}catch{console.log("err")}}const d={keyword:null,category:null,page:1,limit:6};async function k(){const t=i.filtersInput.value;console.log(t),d.keyword=t,t===""&&(d.keyword=null);const e=i.filtersCategories.value;d.category=e,e===""&&(d.category=null),localStorage.setItem("filters",JSON.stringify(d))}_();function _(){const t=JSON.parse(localStorage.getItem("filters"));i.filtersInput&&(i.filtersInput.value=t.keyword||""),i.filtersCategories&&(i.filtersCategories.value=t.category||"")}function E(t){return t.replace(/_/g," ")}async function H(t,e,r=1,o=6){const c=`https://food-boutique.b.goit.study/api/products?keyword=${t}&category=${e}&page=${r}&limit=${o}`;try{const a=await(await fetch(c)).json(),p=a.totalPages;return a.results}catch(s){return console.error("Error fetching products:",s),[]}}async function N(t,e,r=1,o=6){const c=`https://food-boutique.b.goit.study/api/products?keyword=${t}&category=${e}&page=${r}&limit=${o}`;try{const a=await(await fetch(c)).json(),p=a.totalPages;return a}catch(s){return console.error("Error fetching products:",s),[]}}function z(){const t=window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth;return t>=1440?9:t>=768?8:6}function F(t){let e=E(t.category);return`
  ...
  `}const j=localStorage.getItem("filters"),m=JSON.parse(j);async function h(t=1){let e=m.keyword;m.keyword===null&&(e="");let r=m.category;m.category===null&&(r="");const o=z();try{const c=await H(e,r,t,o),s=await N(e,r,t,o),a=c,p=document.getElementById("productList");p.innerHTML="",a.forEach(q=>{p.innerHTML+=F(q)});const A=s.totalPages;renderPagination(A,t)}catch(c){console.error("Помилка:",c)}}document.addEventListener("DOMContentLoaded",()=>{h()});window.changePage=function(t){h(t),console.log(t)};window.addEventListener("resize",h);var C=document.createElement("script");C.src="../js/pagination.js";document.head.appendChild(C);function D(t,e){return t.sort(()=>.5-Math.random()).slice(0,e)}function J(t){let e=E(t.category);return`
...
<li class="pop-text-size-pop">
  ...
  `}x().then(t=>t.data).then(t=>{const e=D(t,5),r=document.getElementById("popularContainer");e.forEach(o=>{r.innerHTML+=J(o)})}).catch(t=>{console.error(t.message)});function R(t,e){return t.sort(()=>.5-Math.random()).slice(0,e)}function W(t){return`
    ...
    `}M().then(t=>t.data).then(t=>{const e=R(t,2),r=document.getElementById("discountContainer");e.forEach(o=>{r.innerHTML+=W(o)})}).catch(t=>{console.error(t.message)});document.querySelector(".productlist-card");function U(t){try{console.log(t);let e=JSON.parse(localStorage.getItem("cart"))||[];console.log(e);const r={id:t,pieces:"1"};e.push(r),localStorage.setItem("cart",JSON.stringify(e))}catch(e){console.log(e)}}async function l(t,e){const r=document.querySelector(".modal-content");r.innerHTML="";const o=await y(t);r.innerHTML=Y(o,e)}function Y(t,e){return`
    ...
    `}const $=document.querySelector(".modal"),G=document.querySelector(".close-button");function S(){$.classList.add("show-modal"),document.body.style.overflow="hidden"}function v(){$.classList.remove("show-modal"),document.body.style.overflow="auto"}function K(t){t.target===$&&v()}G.addEventListener("click",v);window.addEventListener("click",K);document.addEventListener("keydown",function(t){t.keyCode===27&&v()});document.addEventListener("click",function(t){if(!t.target.classList.contains("modal-product-button"))return;const e=t.target.dataset.productlistId;t.target.addEventListener("click",U(e)),t.target.addEventListener("click",v())});function w(t){return new Promise((e,r)=>{const o=document.querySelectorAll(t);if(o.length>0)e(o);else{const c=new MutationObserver(()=>{const s=document.querySelectorAll(t);s.length>0&&(c.disconnect(),e(s))});c.observe(document.documentElement,{childList:!0,subtree:!0})}})}w(".modalOn").then(t=>{t.forEach(e=>{e.addEventListener("click",r=>{const o=r.currentTarget.dataset.productlistId;localStorage.getItem(o)?l(o,"Remove from"):l(o,"Add to"),S()})})}).catch(t=>{console.error(t.message)});w(".modalOndisc").then(t=>{t.forEach(e=>{e.addEventListener("click",r=>{const o=r.currentTarget.dataset.productlistId;localStorage.getItem(o)?l(o,"Remove from"):l(o,"Add to"),S()})})}).catch(t=>{console.error(t.message)});w(".modalOpopul").then(t=>{t.forEach(e=>{e.addEventListener("click",r=>{const o=r.currentTarget.dataset.productlistId;localStorage.getItem(o)?l(o,"Remove from"):l(o,"Add to"),S()})})}).catch(t=>{console.error(t.message)});const u="cart";function V(t,e){localStorage.setItem(e,JSON.stringify(t))}const n={cartBlock:document.querySelector(".js-cart-block"),cartCounter:document.querySelector("span#cart-counter"),deleteAllBtn:document.querySelector(".delete-all-btn"),cartDeleteAllBlock:document.querySelector(".cart-delete-all-section"),cartListBlock:document.querySelector(".cart-list-block"),cartEmptyCart:document.querySelector(".cart-empty-cart"),yourOrderPrice:document.querySelector(".cart-total-price"),spanYourOrderPrice:document.querySelector("span#your-order-total-price"),cardDeleteOneBtn:document.querySelector(".carg-delete-all-btn")};b();function b(){n.cartDeleteAllBlock&&n.cartDeleteAllBlock.setAttribute("hidden",""),n.yourOrderPrice&&n.yourOrderPrice.setAttribute("hidden",""),n.cartEmptyCart&&n.cartEmptyCart.removeAttribute("hidden","")}function Q(){n.cartDeleteAllBlock.removeAttribute("hidden",""),n.yourOrderPrice.removeAttribute("hidden",""),n.cartEmptyCart.setAttribute("hidden","")}X();async function X(){let t=await L(u);if(n.cartCounter.textContent=t.length,t.length===0){n.cartBlock.innerHTML=P(),b();return}Q(),I(),n.deleteAllBtn.addEventListener("click",Z)}async function I(){n.cartListBlock.innerHTML="";let t=L(u);for(const e of t){let r=e.id;console.log(r);try{const o=await y(r),c=et(o,r);n.cartListBlock.innerHTML+=c,document.querySelector(`.js-cart-block .cart-card[data-productlist-id="${r}"] .card-delete-all-btn`).addEventListener("click",()=>{tt(r)})}catch(o){console.error(o.message)}}O(t),n.cartCounter.textContent=t.length}function L(t){try{const e=localStorage.getItem(t);return e?JSON.parse(e):[]}catch(e){console.log(e.message)}}function Z(){localStorage.removeItem(u),n.cartBlock.innerHTML=P(),n.cartCounter.textContent=0}async function tt(t){let e=L(u),r=e.findIndex(o=>o.id===t);r!==-1&&(e.splice(r,1),V(e,u),n.cartListBlock.innerHTML="",await I(),O(e),n.cartCounter.textContent=e.length,e.length===0&&(n.cartBlock.innerHTML=P(),b()))}async function O(t){try{let e=0;const r=t.map(c=>y(c.id));(await Promise.all(r)).forEach(c=>{let s=c.price;e+=s}),n.spanYourOrderPrice.textContent=`$${Number(e.toFixed(2))}`}catch(e){console.error(e.message)}}function P(){return`
...
//# sourceMappingURL=main-d818575a.js.map
