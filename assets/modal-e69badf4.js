import{a}from"./vendor-a61d8330.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))c(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&c(n)}).observe(document,{childList:!0,subtree:!0});function o(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerpolicy&&(r.referrerPolicy=s.referrerpolicy),s.crossorigin==="use-credentials"?r.credentials="include":s.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function c(s){if(s.ep)return;s.ep=!0;const r=o(s);fetch(s.href,r)}})();const l="https://food-boutique.b.goit.study/api";async function h(){try{return await a.get(`${l}/products/categories`)}catch(t){console.log(t.message)}}h().then(t=>console.log(t));async function $(t){try{return(await a.get(`${l}/products/${t}`)).data}catch(e){console.log(e.message)}}let b="640c2dd963a319ea671e3676";$(b).then(t=>console.log(t));async function w(){try{return await a.get(`${l}/products/popular?limit=5`)}catch(t){console.log(t.message)}}w().then(t=>console.log(t));async function P(){try{return await a.get(`${l}/products/discount`)}catch(t){console.log(t.message)}}P().then(t=>console.log(t));async function S({keyword:t,category:e,byABC:o=!0,byPrice:c=!1,byPopularity:s=!1,page:r=1,limit:n=6}){try{const i=new URLSearchParams({category:e,byABC:o?"true":"false",byPrice:c?"true":"false",byPopularity:s?"true":"false",page:r,limit:n});return t&&i.append("keyword",t),(await a.get(`${l}/products?${i}`)).data}catch(i){console.log(i.message)}}const C={category:"Fresh_Produce",byABC:!0,byPrice:!1,byPopularity:!1,page:1,limit:6};S(C).then(t=>console.log(t));const k={email:"ssss@Comment.ua"};async function E(t){return(await a.post(`${l}/subscription`,t)).data}E(k).then(t=>console.log(t)).catch(t=>console.log(t.message));async function I(t){return(await a.post(`${l}/orders`,t)).data}const M={email:"ssss@Comment.ua",products:[{productId:"640c2dd963a319ea671e383b",amount:2}]};I(M).then(t=>console.log(t));const d={filterCatList:document.querySelector(".filters-categories"),form:document.getElementById("fiters-form"),filtersInput:document.querySelector(".filters-input"),filtersCategories:document.querySelector(".filters-categories")};d.form.addEventListener("submit",q);O();async function O(){try{const e=(await h()).data;for(let o=0;o<e.length;o++){let c=A(e[o]);d.filterCatList.insertAdjacentHTML("beforeend",`<option  class="filters-categories-option" value="${c}">${c}</option>`)}}catch{console.log("err")}}const u={keyword:null,category:null,page:1,limit:6};async function q(t){const e=d.filtersInput.value;console.log(e),u.keyword=e,e===""&&(u.keyword=null);const o=d.filtersCategories.value;u.category=o,o===""&&(u.category=null),localStorage.setItem("filters",JSON.stringify(u))}x();function x(){const t=JSON.parse(localStorage.getItem("filters"));d.filtersInput.value=t.keyword,d.filtersCategories.value=t.category}function A(t){return t.replace(/_/g," ")}async function T(t,e,o=1,c=6){const s=`https://food-boutique.b.goit.study/api/products?keyword=${t}&category=${e}&page=${o}&limit=${c}`;try{return(await(await fetch(s)).json()).results}catch(r){return console.error("Error fetching products:",r),[]}}function B(){const t=window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth;return t>=1440?9:t>=768?8:6}function z(t){return`
  ...
  `}const F=localStorage.getItem("filters"),p=JSON.parse(F);console.log(p);async function m(t=1){let e=p.keyword;p.keyword===null&&(e="");let o=p.category;p.category===null&&(o="");const c=B();try{const r=await T(e,o,t,c),n=document.getElementById("productList");n.innerHTML="",r.forEach(v=>{n.innerHTML+=z(v)});const i=Math.ceil(r.length/c);console.log(i),renderPagination(i,t)}catch(s){console.error("Помилка:",s)}}document.addEventListener("DOMContentLoaded",()=>{m()});window.changePage=function(t){m(t),console.log(t)};window.addEventListener("resize",m);var L=document.createElement("script");L.src="/js/pagination.js";document.head.appendChild(L);function _(t,e){return t.sort(()=>.5-Math.random()).slice(0,e)}function H(t){return`
  ...
  `}w().then(t=>t.data).then(t=>{const e=_(t,5),o=document.getElementById("popularContainer");e.forEach(c=>{o.innerHTML+=H(c)})}).catch(t=>{console.error(t.message)});function N(t,e){return t.sort(()=>.5-Math.random()).slice(0,e)}function R(t){return`
    ...
    `}P().then(t=>t.data).then(t=>{const e=N(t,2),o=document.getElementById("discountContainer");e.forEach(c=>{o.innerHTML+=R(c)})}).catch(t=>{console.error(t.message)});function W(t){try{localStorage.getItem(t)?localStorage.removeItem(t):localStorage.setItem(t,JSON.stringify(t))}catch(e){console.log(e)}}async function y(t,e){const o=document.querySelector(".modal-content");o.innerHTML="";const c=await $(t);o.innerHTML=j(c,e)}function j(t,e){return`
    ...
    `}const f=document.querySelector(".modal"),J=document.querySelector(".close-button");function D(){f.classList.add("show-modal"),document.body.style.overflow="hidden"}function g(){f.classList.remove("show-modal"),document.body.style.overflow="auto"}document.querySelectorAll(".productlist-card").forEach(t=>{t.addEventListener("click",function(e){if(t===e.target||t.contains(e.target)){const o=t.dataset.productlistId;localStorage.getItem(o)?y(o,"Remove from"):y(o,"Add to"),D()}})});function U(t){t.target===f&&g()}J.addEventListener("click",g);window.addEventListener("click",U);document.addEventListener("keydown",function(t){t.keyCode===27&&g()});document.addEventListener("click",function(t){if(!t.target.classList.contains("modal-product-button"))return;const e=t.target.dataset.productlistId;t.target.addEventListener("click",W(e)),t.target.addEventListener("click",g())});
//# sourceMappingURL=modal-e69badf4.js.map
