import{a as p}from"./vendor-a61d8330.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))c(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&c(i)}).observe(document,{childList:!0,subtree:!0});function o(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerpolicy&&(s.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?s.credentials="include":r.crossorigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function c(r){if(r.ep)return;r.ep=!0;const s=o(r);fetch(r.href,s)}})();const g="https://food-boutique.b.goit.study/api";async function E(){try{return await p.get(`${g}/products/categories`)}catch(t){console.log(t.message)}}async function f(t){try{return(await p.get(`${g}/products/${t}`)).data}catch(e){console.log(e.message)}}async function q(){try{return await p.get(`${g}/products/popular?limit=5`)}catch(t){console.log(t.message)}}async function A(){try{return await p.get(`${g}/products/discount`)}catch(t){console.log(t.message)}}document.querySelector(".foot-form");document.querySelector(".modal-subscription");document.querySelector(".modal-unsubscription");document.querySelector(".modal-backdrop");document.querySelector(".body");document.body.style.overflow;const a={filterCatList:document.querySelector(".filters-categories"),form:document.getElementById("fiters-form"),filtersInput:document.querySelector(".filters-input"),filtersCategories:document.querySelector(".filters-categories")};a.form.addEventListener("submit",x);I();async function I(){try{const e=(await E()).data;for(let o=0;o<e.length;o++){let c=v(e[o]);a.filterCatList.insertAdjacentHTML("beforeend",`<option  class="filters-categories-option" value="${c}">${c}</option>`)}}catch{console.log("err")}}const l={keyword:null,category:null,page:1,limit:6};async function x(t){const e=a.filtersInput.value;console.log(e),l.keyword=e,e===""&&(l.keyword=null);const o=a.filtersCategories.value;l.category=o,o===""&&(l.category=null),localStorage.setItem("filters",JSON.stringify(l))}B();function B(){const t=JSON.parse(localStorage.getItem("filters"));a.filtersInput.value=t.keyword,a.filtersCategories.value=t.category}function v(t){return t.replace(/_/g," ")}async function M(t,e,o=1,c=6){const r=`https://food-boutique.b.goit.study/api/products?keyword=${t}&category=${e}&page=${o}&limit=${c}`;try{return(await(await fetch(r)).json()).results}catch(s){return console.error("Error fetching products:",s),[]}}function O(){const t=window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth;return t>=1440?9:t>=768?8:6}function T(t){let e=v(t.category);return`
  ...
  `}const z=localStorage.getItem("filters"),u=JSON.parse(z);async function y(t=1){let e=u.keyword;u.keyword===null&&(e="");let o=u.category;u.category===null&&(o="");const c=O();try{const s=await M(e,o,t,c),i=document.getElementById("productList");i.innerHTML="",s.forEach(C=>{i.innerHTML+=T(C)});const k=Math.ceil(s.length/c);renderPagination(k,t)}catch(r){console.error("Помилка:",r)}}document.addEventListener("DOMContentLoaded",()=>{y()});window.changePage=function(t){y(t),console.log(t)};window.addEventListener("resize",y);var w=document.createElement("script");w.src="/js/pagination.js";document.head.appendChild(w);function H(t,e){return t.sort(()=>.5-Math.random()).slice(0,e)}function N(t){let e=v(t.category);return`
  ...
  `}q().then(t=>t.data).then(t=>{const e=H(t,5),o=document.getElementById("popularContainer");e.forEach(c=>{o.innerHTML+=N(c)})}).catch(t=>{console.error(t.message)});function _(t,e){return t.sort(()=>.5-Math.random()).slice(0,e)}function F(t){return`
...
//# sourceMappingURL=cart-be973b56.js.map
